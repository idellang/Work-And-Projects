---
title: "processing transpecial change tolerance"
author: "Me"
date: "2/10/2021"
...
```{r}
points_in_geofences %>%
      write_csv('points_in_geofences.csv')
```


```{r}
points_in_geofences = read_csv('points_in_geofences.csv')
```
...
vehicle_location_group = points_in_geofences %>%
      mutate(track_period = floor_date(datestamp, '15 minutes')) %>%
...
morethan5mins %>%
      ...
      write_csv('checking_with_changes.csv')
```
...
morethan5mins %>%
      ...
      write_csv('checking2_with_changes.csv')
...
morethan5mins %>%
      ...
      write_csv('checking3_with_changes.csv')
```
...
fixed_data%>%
      ...
      write_csv('fixed_data_with_changes.csv')
```
...
fixed_data_arranged %>%
      mutate(first_timestamp = as.character(first_timestamp),
             last_timestamp = as.character(last_timestamp)) %>%
      write_csv('fixed_data_arranged_with_changes.csv')
```
